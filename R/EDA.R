...
# Save to disk
fwrite(biomass_dt, "biomass_complete_data.csv")
...
fwrite(biomass_dt, "biomass_complete_data_with_bg.csv")
...
print(p1)
ggsave("Figures/biomass_by_biogeoregion_density.png", p1, width = 16, height = 12, dpi = 300)
...
print(p3)
ggsave("Figures/biomass_by_biogeoregion_boxplot.png", p3, width = 16, height = 12, dpi = 300)
...
# Save summary to CSV
fwrite(summary_stats, "Data/biomass_summary_by_biogeoregion_forest.csv")
...
print(p4)
ggsave("Figures/biomass_summary_by_biogeoregion.png", p4, width = 12, height = 6, dpi = 300)
...
print(p5)
ggsave("Figures/pixel_counts_by_biogeoregion.png", p5, width = 12, height = 6, dpi = 300)
