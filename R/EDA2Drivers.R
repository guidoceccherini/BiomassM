...
# Save to disk
fwrite(biomass_dt, "biomass_complete_data_deltaABGDrivers.csv")
...
fwrite(biomass_dt, "biomass_complete_data_with_bg_deltaABGDrivers.csv")
...
print(p1)
ggsave("Figures/biomass_by_biogeoregion_density_AGBLOSSDrivers.png", p1, width = 16, height = 12, dpi = 300)
...
print(p2)
ggsave("Figures/biomass_by_biogeoregion_violinDrivers.png", p2, width = 16, height = 12, dpi = 300)
...
print(p3)
ggsave("Figures/biomass_by_biogeoregion_boxplot_AGBLOSSDrivers.png", p3, width = 16, height = 12, dpi = 300)
...
print(p4)
ggsave("Figures/biomass_summary_by_biogeoregion_AGBLOSSDrivers.png", p4, width = 12, height = 6, dpi = 300)
...
print(p5)
ggsave("Figures/pixel_counts_by_biogeoregion_AGBLOSSDrivers.png", p5, width = 12, height = 6, dpi = 300)
