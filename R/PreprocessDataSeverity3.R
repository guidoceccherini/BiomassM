...
for(folder in country_folders) {
  ...
  severity_2011_2023 <- severity[[24:35]]
  ...
  severity_min <- app(severity_2011_2023, min, na.rm = TRUE)
  ...
  # Define output paths
  output_dist <- file.path(folder, "severity_2008_2019.tif")
  ...
  rm(Disturbances, r_binned, mask,  severity,
     severity_2011_2023, severity_min, disturbance_binary)
  gc()
}
