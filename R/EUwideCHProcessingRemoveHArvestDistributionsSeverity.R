...
for(folder in country_folders) {
  ...
  output_severity <- file.path(folder, "severity_2011_2023.tif")
...
write_csv(final_data, "Data/biomass_EU_CH_by_hexagon_disturbed_vNoHarvestSeverity.csv")
...
write_csv(final_dataUND, "Data/biomass_EU_CHby_hexagon_undisturbed_vNoHarvestDistributions.csv")
