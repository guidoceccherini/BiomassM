...
# Save to disk
fwrite(biomass_dt, "biomass_complete_data_delta.csv")
...
p1 <- ggplot(biomass_df, aes(x = biomass, fill = forest_type_label)) +
  ...
  labs(title = "Biomass Loss Distribution in Disturbed Pixels",
...
fwrite(biomass_dt, "biomass_complete_data_with_bg_delta.csv")
...
p2 <- ggplot(biomass_df, aes(x = forest_type_label, y = biomass, 
  ...
  labs(
    title = "Biomass Loss (2020 - 2010) Distribution in Disturbed Pixels by Bio-geographical Region",
    x = "Forest Type",
...
print(p2)
ggsave("Figures/biomass_by_biogeoregion_violinLoss.png", p2, width = 16, height = 12, dpi = 300)
...
print(p4)
ggsave("Figures/biomass_summary_by_biogeoregion_AGBLOSS2.png", p4, width = 12, height = 6, dpi = 300)
...
print(p5)
ggsave("Figures/pixel_counts_by_biogeoregion_AGBLOSS2.png", p5, width = 12, height = 6, dpi = 300)
