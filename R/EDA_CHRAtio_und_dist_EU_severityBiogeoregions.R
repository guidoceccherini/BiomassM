...
p_combined <- ggplot(data_for_plot, aes(x = biomass_2020/10, y = severity_label, fill = severity_numeric)) +
  stat_density_ridges(
  ...
  labs(
    ...
    subtitle = "Distribution of Disturbed Canopy Height (all forest types)",
    x = "Canopy Height Disturbed",
    y = NULL
  )

print(p_combined)
ggsave("Figures/joy_division_CHdist_by_region_combined.png", p_combined,
...
p_classic <- ggplot(data_filtered, aes(x = biomass_2020/10, y = severity_label, fill = after_stat(x))) +
  stat_density_ridges(
    geom = "density_ridges_gradient",
    scale = 2.5,
    rel_min_height = 0.01,
  ...
  labs(
    title = "Forest Canopy Height European Biogeographic Regions",
    subtitle = "From heavily disturbed to undisturbed forests",
    x = "Canopy Height (Disturbed)",
    y = NULL
  )
...
print(p_classic)
ggsave("Figures/joy_division_CH_filtered.png", p_classic, 
...
p_clean <- ggplot(data_filtered_clean, aes(x = biomass_2020/10, y = severity_label, fill = after_stat(x))) +
  stat_density_ridges(
    geom = "density_ridges_gradient",
    scale = 2.8,
    rel_min_height = 0.01,
  ...
  scale_fill_viridis(
    ...
    # midpoint = 1,
    # limits = c(0, 200),
    name = "Canopy Height (Disturbed) [m]",
    guide = guide_colorbar(
  ...
  labs(
    title = "Forest Canopy Height Across European Biogeographic Regions",
    subtitle = "Distribution of Canopy Height by disturbance severity",
    x = "Canopy Height",
    y = NULL
  )

print(p_clean)
ggsave("Figures/joy_division_CH_clean.png", p_clean, 
...
#   ) +
#   labs(
#     title = "Canopy Height Recovery by Disturbance Severity Across Biogeographic Regions",
#     subtitle = "Distribution of Disturbed/Undisturbed Canopy Height ratios (all forest types)",
#     x = "Canopy Height Ratio (Disturbed / Undisturbed)",
#     y = NULL
#   )
# 
# print(p_combined)
# ggsave("Figures/joy_division_CHratio_by_region_combined.png", p_combined, 
#        width = 16, height = 10, dpi = 300)
# 
# # 
# # 
